...
struct TOSView: View {
    ...
    var TOSString = """
            ...
            Application means the software program provided by the Company downloaded by You on any electronic device, named Panic Attack
            ...
            Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Panic Attack LLC, 3101 N. Central Ave. STE# 183-4692 Phoenix, AZ 85012.
            ...
            Website refers to Panic Attack , accessible from https://thepanicattack.app
            ...
            ·       By mail: 3101 N. Central Ave. STE# 183-4692 Phoenix, AZ 85012, United States
    """
}
